...
### Current Issues (updated at 26.10.2025 the end of the hackaton)
...
python scripts/reinforcement_learning/rsl_rl/train.py --task RobotLab-Isaac-Velocity-Jump-Booster-T1-v0 \
--headless --num_envs 16384
```
